    ...
    },
    {
        'in' : {
            'params' : {
                ...
                'params' : {
                    'SILAC_AAS_LOCKED_IN_EXPERIMENT' : ['K','R']
                }
            }
        },
        'out' : {
            'formated_molecule' :sorted(['K0LEINER0TEST', 'K1LEINER1TEST']),
        }
    },
    {
        'in' : {
        ...
        'out' : {
            'formated_molecule' :sorted(['K0LEI0NER0TEST', 'K1LEI0NER1TEST']),
        }
    },
    {
        'in' : {
        ...
        'out' : {
            'formated_molecule' :sorted(['K0LEI0NER0TEST', 'K1LEI0NER1TEST','K0LEI1NER0TEST', 'K1LEI1NER1TEST', ]),
        }
    },
    {
        'in' : {
