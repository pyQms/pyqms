...
TESTS = [
    [
        ...
        {"in": {"args": ["ICAT-G:2H(8)"]}, "out": "9"},  # pyqms.UnimodMapper.name2id,
        {"in": {"args": ["9"]}, "out": 494.30142},  # pyqms.UnimodMapper.id2mass,
        {
            "in": {"args": ["9"]},
            "out": {"N": 4, "S": 1, "2H": 8, "O": 6, "C": 22, "H": 30},
        },  # pyqms.UnimodMapper.id2composition,
        {"in": {"args": "9"}, "out": "ICAT-G:2H(8)"},  # pyqms.UnimodMapper.id2name,
        {
            "in": {"args": [494.30142]},
            "out": ["ICAT-G:2H(8)"],
        },  # pyqms.UnimodMapper.mass2name_list,
        {"in": {"args": [494.30142]}, "out": ["9"]},  # pyqms.UnimodMapper.mass2id_list,
        {
            "in": {"args": [494.30142]},
            "out": [{"N": 4, "S": 1, "2H": 8, "O": 6, "C": 22, "H": 30}],
        ...
        {"in": {"args": ["Ala->Gln"]}, "out": ["A"]},
        {"in": {"args": ["C(22)H(30)2H(8)N(4)O(6)S(1)"]}, "out": ["9"]},
        {"in": {"args": ["C(22)H(30)2H(8)N(4)O(6)S(1)"]}, "out": 494.30142},
        {"in": {"args": ["ThisKeyIsNotPresent", "mass"]}, "out": None},
